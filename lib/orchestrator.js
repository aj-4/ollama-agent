const OpenAIClass = require('./aiClients/openai.js').default;
const OllamaClass = require('./aiClients/ollama.js').default;
        ...
        const completion = await this.ai.run({
            ...
            messages: [
                ...
                },
                {
                    ...
                    Workflow Function Definitions: ${JSON.stringify(Object.values(this.workflows).map(w => w.definition))}
    ...
    async execute() {
        try {
            ...
            while (!complete) {
                ...
                console.log('Running Workflow:', selectedWorkflow.name, 'to', selectedWorkflow.goal);
